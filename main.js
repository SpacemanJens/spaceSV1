...
const screenLayout = {
  ...
  startPlanetIndex: 3,
  diameterPlanet: 1500,  // 1500/3838 Must be the same as the actual size of the background image found in preload()
  cropWidth: 700, // 1800
  cropHeight: 700, // 1200
  xGameArea: 600,
  yGameArea: 50,
...
function setup() {
  ...
  planet = new BasicMinimap(x = 300, y = 300, diameter = 400, color = 'grey', diameterPlanet = screenLayout.diameterPlanet);
...
//s
function preload() {
  partyConnect("wss://p5js-spaceman-server-29f6636dfb6c.herokuapp.com", "jkv-spaceSV2a");
